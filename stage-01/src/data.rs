...
impl Default for Data {
    fn default() -> Self {
        Self {
            ...
            track: String::new(),
            github_file_url: String::from("https://github.com/poopsicles/HNGx-rusty/blob/main/stage-one/src/main.rs"),
            github_repo_url: String::from("https://github.com/poopsicles/HNGx-rusty"),
